...
<Steps>
  <Step title="Access the Dashboard">
    Go to the [API Access](https://semust.com/api/access) page in your dashboard.
  </Step>
...
<Tip>
  Double-check that both `SEMUST-API-USER` and `SEMUST-API-PASSWORD` headers are present and contain the correct values from your [API Access](https://semust.com/api/access) page.
</Tip>
